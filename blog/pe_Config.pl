## Dies ist die Konfigurationsdatei des Blogs, sie ist durch pe_Config.pl.bak gesichert
## Verändern Sie die Einstellungen nach ihren Wünschen!
## Bei 0 oder 1 als Möglichkeiten, 0=Nein 1=Ja
## für Dateipfäde: .=im selben Ordner wie pe_pplog-pl und pe_admin.pl ..=ein Ordner höher

# Für den Blog benötigte Einstellungen
our $config_adminPass = 'puppy';												# Administrator Passwort
																				
##Optionale Einstellungen
#Persönlihe Einstellungen									
our $config_blogHeader= 'pe_pplog';												# Überschrift der Webseite
our $config_blogFooter='';														# Fußzeile
our $config_blogTitle = 'blog';													# Titel der Webseite 

#Dateiordner:																	
our $config_DatabaseFolder = './blog';										# Kompletter Pfad, sollte ausserhalb des Hauptverzeichniss des Servers liegen, aber der Server muss Lese- und Schreiberlaubnisse haben
our $config_smiliesFolder = '/pe_pplog/images/smilies';									# Pfad zum "smilies" Ordner relativ vom Hauptverzeichniss des Servers. Smilies können nach Wunsch verändert oder hinzugefügt werden.  
our $config_currentStyleFolder = '/pe_pplog/css';										# Order für Stilvorlage, auch relativ vom Hauptverzeichniss des Servers aus
our $config_currentStyleSheet = 'style.css';									# Dateiname der Stilvorlage
our $config_tmpFolder = '/tmp';													# Kompletter Pfad zum tmp Ordner

#Aussehen und Verhalten:
our $lang = "GER";																# Spracheinstellung (GER ES EN EL CUSTOM), eigene Übersetzungen unten bei "$locale{"CUSTOM}= hinzufügen
our $config_enableJQuery = 1;													# JQuery = Javascript Bibliothek, die für Lightboxes und andere Spezialeffekte verwendet wird
our $config_entriesPerPage = 5;													# Wieviele Einträge pro Seite angezeigt werden
our $config_maxPagesDisplayed = 5;												# Wieviele Seiten angezeigt werden  
our $config_gmt = +4;															# Ihre GMT, Deutschland +1
our $config_entriesOnRSS = 0;													# 0 = Alle Einträge, sont zeigt die Zahl eine Begrenzung an
...
our $config_showHits = 1;														# Anzeige der Aufrufe
our $config_showUsersOnline = 0;												# Anzeige wieviele Besucher auf der Seite sind
our $config_usersOnlineTimeout = 120;											# Zeitgrenze wie lange ein Besucher als online gilt 

#Einstellungen für Kommentare:
our $config_allowComments = 1;													# Kommentare erlauben
our @config_commentsForbiddenAuthors = qw/admin administrator/;					# Diese Benutzernamen sind für den Administrator reserviert, der Erste in der Reihe wird automatischals Name für Kommentare verwendet 

our $config_commentsSecurityCode = 1;											# CAPTCHA um Spam bei Kommentaren zu verhindern
our $config_securityQuestionOnComments = 0;										# Sicherheitsfrage für Kommentare um Spam zu verhindern oder ein Passwort für Kommentare zu benutzen
our $config_commentsSecurityQuestion = 'Name of the Puppy Linux mascot?';		# Sicherheitsfrage
our $config_commentsSecurityAnswer = 'Puppy';									# Antwort

our $config_bbCodeOnCommentaries = 1;											# Bbcode Schaltfläche für Kommentare
our $config_commentsMaxLenght = 2000;											# Maximale Zeichenanzahl für Kommentare
our $config_commentsPerPage = 20;												# Wie viele Kommentare pro Eintrag erlaubt sind									

our $config_sendMailWithNewComment = 0;											# Eine email für neue Kommentare versenden, "sendmail" muss installiert sein
our @config_sendMailWithNewCommentMail = ('/usr/bin/sendmail -t','me@example.com');						# Email Adresse für neue Kommentare oder Kontakt plugin  		

#Für Suchmaschienen:
our $config_metaRobots = 'noimageindex';										# Optionen für Suchmaschienen: noindex nofollow nosnipped noimageindex  noodp noarchive unavailable_after:[date] none
our $config_metaDescription = 'pe_pplog';				            		    # Beschreibung für Suchmaschienen
our $config_metaKeywords = 'post, perl, blog, flat files';			  			# Stichwürter für Suchmaschienen
			
#Sicherheit
our $config_useHTTPSlogin = 0;													# Möchten sie eine SSL Verbindung (HTTPS) für die Administratorseite verwenden
our $config_randomString = 'zjhd092nmbd20dbJASDK1BFGAB1';						# Wird für verschlüsselung gebrauch, ändern nach Wunsch
our @config_ipBan = qw/202.325.35.145 165.265.26.65/;							# Gesperrte IP Adressen, 2 Beispiele (Ändern Sie sie, falls es ihre ist)					
...
our @config_pluginsAdmin = qw(editConfig newGallery notes emails upload);		#vorhanden: editConfig newGallery notes emails upload Hier die Erweiterungen für die Administratorseite hinzufügen
...
our $config_customMenuHTMLtop = ''; 											# Zum Beispiel ein "Reddit" Button: <a target="_blank" href="http://reddit.com/submit?url=http://'.$ENV{'HTTP_HOST'}.$ENV{'REQUEST_URI'}.'">Reddit This <img border="0" src="reddit.gif" /></a>';								
our $config_customMenuHTMLbottom = '';											# HTML für die untere Hälfte des Menüs
our $config_customHTMLpost = '';												# ein Pltz für Buttons von Sozialen Netzwerken
our $config_customHTMLhead = '';												# falls Sie Javascript zu dem öffentlichen Blog...								
our $config_customHTMLadmin = '';												# oder der Administratorseite hinzufügen wollen

our %locale;																	# Vorhandene Übersetzungen, um eine eigene hinzuzufügen siehe $locale {"CUSTOM"}
...
makegallery => "Neue Gallerie erstellen",
...
contact => "Contacto",
send => "Enviar",
contactonfo => "Información de Contacto",
...
compass => "Wrong password for this nickname. Please try again or choose another nickname.",
newuser => "You are a new user posting here... You will be added to a database so nobody can steal your identity. Remember your password!",
mmail => "Hello, I'm sending this mail because of a new comment on your blog: http://$ENV{'HTTP_HOST'}$ENV{'REQUEST_URI'}\nRemember you can disallow this option changing the \$config_sendMailWithNewComment Variable to 0. \nComment content: \n",
subject => "New comment on the pe_pplog",
author => "Author",
code => "Security Code",
password => "Password",
