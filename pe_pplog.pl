...
#####################################################################
# 	pe_pplog (pretty easy pplog) v.2.1b								#
#	Die Idee hinter diesem Program ist die Vielseitigkeit von 		#
#	Jquery mit dem schlichten Konzept des ursprünglichen PPLOGs in	# 
#	einen modernen Blog mit Anpassungs- und 						#
#	Erweiterungsmöglichkeiten zu verbinden.							#
#																	#
#	Dieser Blog basiert auf  PPlog Version: 1.1b programmiert von	# 
#	Federico Ramírez (fedekun)										#
#	Die vorgenommenen Veränderungen sind in dem Dokument CHANGELOG	#  
#	aufgelisted.  Änderungen sind imm Code mit "efia" gekennzeicnet.#
#																	#
#	pe_pplog und PPLOG sind unter der GNU Public Licence v3			#
#	http://www.opensource.org/licenses/gpl-3.0.html	veröffentlich	#
#																	#
#	Kommentare oder  Fragen bitte an svala.3@gmail.com schicken		#										#
#																	#
...
#Dies ist die Öffentliche Seite
...
<body><header>
<a href=?page=1 style="text-decoration:none;"><h1 id="header">'.$config_blogHeader.'</h1></a><a id="mobile" href="">'.$locale{$lang}->{menu}.'</a>
...
print '</nav><footer id="footer">'.$config_blogFooter.'</footer></div></body></html>';
}
#done!
